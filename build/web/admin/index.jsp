    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="https://docs.google.com/spreadsheets/d/1zK7j8oIL6F5Ir5G_dy-N8vwXeAVdd8GlM7SrlXgsMss/edit#gid=0" target="_blank"><i class='app-menu__icon bx bx-task'></i><span
        ...
        <main class="app-content">
            ...
            <style>
                ...
                /* Checkbox */
                .checkbox-container .text-center {
            ...
            <div class="row">
                <div class="checkbox-container">
                    <div class="text-center" style="font-size: 13px">
                        <input type="checkbox" id="customerCheckbox" onchange="updateStatistics()"> Tổng khách hàng
                    </div>
                    <div class="text-center" style="font-size: 13px">
                        <input type="checkbox" id="productCheckbox" onchange="updateStatistics()"> Tổng sản phẩm
                    </div>
                    <div class="text-center" style="font-size: 13px">
                        <input type="checkbox" id="orderCheckbox" onchange="updateStatistics()"> Tổng đơn hàng
                    </div>
                    <div class="text-center" style="font-size: 13px">
                        <input type="checkbox" id="outOfStockCheckbox" onchange="updateStatistics()"> Sắp hết hàng
                    </div>
                </div>
